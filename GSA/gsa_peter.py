...
def main_eval(args, model, tokenizer, device):
    if args.repetition_penalty is not None:
        ...
        input("Applying Repetition Penalty.")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--granu", type=int, default=[1, 4, 16])
    parser.add_argument("--local", type=float, default=[0.0, 0.5, 1.0])
    ...
    parser.add_argument("--checkpoint", type=str, default="TinyLlama\GSA1_Residual_64\Ver_2\checkpoint-33000")
